(ns aoc2024.day7.exhaustive-test
  (:require [clojure.test :refer [deftest is testing]]
            [aoc2024.day7.exhaustive :as sut]))
...
(deftest evaluate-test
  (testing "evaluates expressions correctly"
    (is (= 156 (sut/evaluate [15 6] [:||])))
    (is (= 7290 (sut/evaluate [6 8 6 15] [:* :|| :*])))
    (is (= 192 (sut/evaluate [17 8 14] [:|| :+])))))
